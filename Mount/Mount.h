...
BOOL MountFavoriteVolumes (BOOL systemFavorites = FALSE, BOOL logOnMount = FALSE, BOOL hotKeyMount = FALSE, const nemesis::FavoriteVolume &favoriteVolumeToMount = nemesis::FavoriteVolume());
