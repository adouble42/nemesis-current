...
namespace nemesis
{
	...
	void LanguageStrings::Init ()
	{
		...
		Map["CONFIRM_BACKGROUND_TASK_DISABLED"] = _("WARNING: If the nemesis Background Task is disabled, the following functions, depending on the platform, will be disabled whenever you exit nemesis:\n\n1) Auto-dismount (e.g., upon logoff, time-out, etc.)\n2) Notifications (e.g., when damage to hidden volume is prevented)\n3) Tray icon\n\nNote: You may shut down the Background Task anytime by right-clicking the nemesis tray icon and selecting 'Exit'.\n\nAre you sure you want to disable the nemesis Background Task?");
		Map["CONFIRM_EXIT"] = _("WARNING: If nemesis exits now, the following functions, depending on the platform, will be disabled:\n\n1) Auto-dismount (e.g., upon logoff, time-out, etc.)\n2) Notifications (e.g., when damage to hidden volume is prevented)\n3) Tray icon\n\nNote: If you do not wish nemesis to continue running in background after you close its window, disable the Background Task in the Preferences.\n\nAre you sure you want nemesis to exit?");
		...
		Map["ENTER_TC_VOL_PASSWORD"] = _("Enter nemesis Volume Password");
		...
		Map["CHECKING_FS"] = _("Checking the file system on the nemesis volume mounted as {0}...");
		Map["REPAIRING_FS"] = _("Attempting to repair the file system on the nemesis volume mounted as {0}...");
